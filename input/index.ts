...
const playGame = (): void => {
  ...
  // display hint
  const displayHint = (secretNumber: string, guessedNumber: string) => {
    let bulls = 0;
    let cows = 0;
...
🔸🔹🔸🔸🔹🔸🔸🔹🔸🔸🔹🔸🔸🔹🔸🔸🔹🔸🔸🔹🔸🔹🔸🔹🔸
  ...
  while (!isGuessCorrect) {
    const guessedNumber = prompt(
      chalk.whiteBright("   Enter your 4-digit guess: ")
    );
    ...
    console.log("\n🔹🔹🔹🔹🔹🔹🔹🔹🔹🔹🔹🔹🔹🔹🔹🔹");
    console.log(
      chalk.yellowBright(` Your guess: ${chalk.whiteBright(guessedNumber)}`)
    );
    console.log(
      chalk.yellowBright(` Attempts: ${chalk.whiteBright(attempts)}`)
    );
    ...
    if (guessedNumber === secretNumber) {
      isGuessCorrect = true;
      console.log(
        chalk.redBright("✨🎊Congratulations🎊✨") +
          chalk.whiteBright(
